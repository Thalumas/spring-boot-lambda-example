...
import uk.co.thalumas.lambda.StreamLambdaHandler;
...
public class StreamLambdaHandlerTest {
    ...
    @Test
    public void greet_streamRequest_respondsWithHello() {
        InputStream requestStream = new AwsProxyRequestBuilder("/greet", HttpMethod.POST)
        ...
        assertTrue(response.getBody().contains("Greetings Tim"));
